...
// const TopBar = () => {
//   return (
//     <div className="w-[1280px] h-[54px] bg-[#F7F7F7] pr-[64px] pl-[62px] flex items-center justify-between border-b-[1px] border-black ">
...
const TopBar = () => {
  return (
    <div className='hidden md:flex w-[1280px] h-[54px] bg-[#F7F7F7] px-4 sm:px-6 md:px-8 lg:px-[62px] items-center justify-between border-b-[1px] border-black mb-5'>
      ...
      <div className='flex items-center space-x-4 text-lg sm:text-xl md:text-2xl '>
        <CgFacebook size={20} />
        <FaInstagram size={20} />
        <FaTwitter size={20} />
        <FaLinkedin size={20} />
