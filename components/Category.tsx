...
// const Category = () => {
//   return (
//     <div id="Services" className="py-[112px] px-[16px] mt-[20px] text-center">
//       <h1 className="text-5xl font-bold">Explore Courses By Category</h1>
//       <p className="text-lg pt-5">
//         Discover a wide range of courses covering a variety of subjects, taught
//         by expert instructors.
...
//         {/* Card 1 */}
//         <div className="w-full h-[132px] p-[20px] rounded-[5px] bg-[#F7F7F7] flex items-center gap-6 text-center">
//           <Image
//             src={"/images/cate-00.svg"}
//             alt="category-1"
//             height={80}
...
const Category = () => {
  return (
    <div id="Services" className="py-[112px] px-[16px] mt-[20px] text-center">
      ...
      {/* Grid Container for Cards */}
      <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-10 mt-20">
        {/* Card 1 */}
        <div className="w-full h-[132px] p-[20px] rounded-[5px] bg-[#F7F7F7] flex items-center gap-6 text-center">
          <Image
            src={"/images/cate-00.svg"}
