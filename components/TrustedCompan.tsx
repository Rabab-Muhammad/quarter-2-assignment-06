...
const TrustedCompan = () => {
  return (
    <div className="py-[80px] px-[16px] md:px-[64px] w-full bg-[#F7F7F7] flex flex-col md:flex-row justify-center items-center mt-0">
      <h1 className="font-bold text-2xl text-center md:text-left mb-6 md:mb-0">
        Trusted by 2000+ companies worldwide.
      </h1>

      <div className="flex flex-wrap justify-center gap-8 md:justify-between items-center mt-10">
